...
(function() {
    ...
    var confirm_modal = instance.stock_irm.modal.widget.extend({
        init: function () {
            this._super();
            var self = this;
            self.body_template = 'confirm_inbound_modal';
            self.footer_template = 'confirm_note';
            self.title = 'Confirm this picking';
            self.block_modal = true;
        },
        start: function (orders) {
            var self = this;
            ...
            self.add_listener_on_confirm_note_button(orders);
        },
        ...
        add_listener_on_confirm_note_button: function(orders){
            var self = this;
    ...
    instance.stock_irm.modal.confirm_modal = confirm_modal;
