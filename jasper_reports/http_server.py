...
class JasperHandler(BaseHTTPRequestHandler):
    ...
    def execute(self, path):
        ...
        uid = openerp.netsvc.dispatch_rpc('common', 'login', (database, user, password))
        result = openerp.netsvc.dispatch_rpc('object', 'execute', (database, uid, password, 'ir.actions.report.xml', 'create_xml', model, depth, context))
